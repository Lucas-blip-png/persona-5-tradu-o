...
Gera rascunhos de qualidade com um provedor de IA à sua escolha (contexto rico: glossário +
guia de estilo + voz do personagem + cena). Tudo sai como `status: "draft"` — **rascunho, não
final**. Requer as variáveis de ambiente `P5R_AI_API_URL`, `P5R_AI_API_KEY` e `P5R_AI_MODEL`
(API compatível com "chat completions"). É opcional: o fluxo 100% humano funciona sem ele.
